...
t("control", "/health and /spec report 0.4.6", spec.version === "0.4.6" && (await (await worker.fetch(new Request(O + "/health"), ENV, CTX)).json()).gate_version === "0.4.6", JSON.stringify(spec.version));
