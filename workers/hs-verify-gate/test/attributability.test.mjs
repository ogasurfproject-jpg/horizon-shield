...
t("control", "/health and /spec report 0.4.8", spec.version === "0.4.8" && (await (await worker.fetch(new Request(O + "/health"), ENV, CTX)).json()).gate_version === "0.4.8", JSON.stringify(spec.version));
