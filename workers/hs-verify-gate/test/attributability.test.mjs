...
t("control", "/health and /spec report 0.4.7", spec.version === "0.4.7" && (await (await worker.fetch(new Request(O + "/health"), ENV, CTX)).json()).gate_version === "0.4.7", JSON.stringify(spec.version));
