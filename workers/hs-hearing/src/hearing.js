...
const VERIFY_MD =
  ...
  "- 実際の見積もり例を、オープン建設費DB(JCCDB 95,403品目)と souba-db に照合し適正価格を検証。\n" +
...
function mallOverview(contractors) {
  ...
  return {
    ...
    dataset: "JCCDB 95,403品目に照合(souba-db, 大賀俊勝 実務監修)",
  ...
  async fetch(request, env, ctx) {
    ...
    if (path === "/contractors.json") {
      ...
      return json({
        ...
        stats: { source_count: 8, jccdb_items: 95403, as_of: "2026-06-30" },
