...
export const INDUSTRIES = {
  ...
  nursing: {
    ...
    bank: {
      ...
      /* 減算の要件。data/nursing/rules_2024.json の requirements[].ask と
         ...
         設問文に要件の中身を書くときは、data/nursing/rules_2024.json で
         confirmed:true になっているものだけにする。2026-08-23、
         「訪問看護は年1回以上が要件です」と書いていたが、これは二次資料に
         しか無い記述だった。お客様に自社の遵守状況について断定を伝えるのは、
         我々がいちばんやってはいけないことなので、外した。 */
      ...
      /* --- 外向き(ケアマネさん向けの集客) ------------------------- */
      /* 処置ごとの説明。ここが空だと、地域×処置のページは作られない。
