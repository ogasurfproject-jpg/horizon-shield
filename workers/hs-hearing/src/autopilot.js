...
export const QUESTION_BANK = {
  ...
  recruit: {
    ...
    q_recruit_growth:  { w: 3, text: "未経験者の受け入れ可否と、入社後に身につく資格・技術を教えてください(例: 未経験可、先輩と2人1組で1年、施工技能士の取得支援あり)。" },
  },
  leads: {
  ...
  homeowners: {
    ...
    q_home_makers:     { w: 4, text: "対応できる主要メーカー・ブランドと、御社が特に得意とする工法・仕様を教えてください(例で構いません)。" },
    q_home_subsidy:    { w: 3, text: "使える補助金・助成金があれば、申請サポートの有無と対応できる制度を教えてください(なければ「なし」で構いません)。" },
  },
  franchise: {
