...
KNOWN = {
    ...
    "ADMIN_TOKEN":        {"local": "~/jidec/hs_outreach_token (chmod 600, 64 hex, no newline); the outreach brain trigger reads it as $HOME/mnt/jidec/hs_outreach_token",
                           "rotated": "2026-09-05 (the old value had been pasted into a chat by hand and sat inside the brain v4 trigger prompt; both copies are dead)",
                           "note": "hs-outreach status/enqueue/pause/drain. Set from the file with `npx wrangler secret put ADMIN_TOKEN < ~/jidec/hs_outreach_token`, never typed"},
