...
恒久ルール:
  ...
  - 禁止語(MOAT語。MOAT_FORBIDDEN 参照、逆順表記)を本文に出さない。
  - 会社名 The HORIZONs株式会社(音インタクト)。em/en/bar dash 不使用。
...
def org_person_graph(canonical):
    return {"@context":"https://schema.org","@graph":[
        {"@type":"Organization","@id":BASE+"/#org","name":"HORIZON SHIELD","alternateName":"The HORIZONs株式会社","url":BASE,"telephone":"0463-74-5917"},
...
'<p><strong>運営:</strong> The HORIZONs株式会社 / HORIZON SHIELD / Yakumo</p>'
'</div></div>'
...
def llmo_page(profile, kind, idx):
    ...
    ld = {"@context":"https://schema.org","@type":"Article","headline":h1,"author":{"@type":"Person","name":"大賀俊勝","identifier":ORCID},
          "publisher":{"@type":"Organization","name":"The HORIZONs株式会社","alternateName":"HORIZON SHIELD"},"mainEntityOfPage":canonical,"inLanguage":"ja"}
    body = header_html()
...
def focus_page(profile, focus, news):
    ...
    ld = {"@context": "https://schema.org", "@type": "Article", "headline": h1,
          ...
          "publisher": {"@type": "Organization", "name": "The HORIZONs株式会社", "alternateName": "HORIZON SHIELD"},
